...
import com.grsu.schedule_project.presentation.common.snackbarhelpers.SNACK_BAR_CAUSE_ERROR
...
class GroupsFragment : Fragment(R.layout.fragment_groups), BackButtonListener {
    ...
    private fun subscribeUi() {
        ...
        groupsViewModel.groupItemViewModelList.observe(viewLifecycleOwner) { facultyItemViewModelList ->
            groupAdapter.submitList(facultyItemViewModelList)
        }
    }
