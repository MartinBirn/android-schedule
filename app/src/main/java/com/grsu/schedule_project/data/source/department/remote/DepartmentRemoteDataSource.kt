...
class DepartmentRemoteDataSource(
    ...
    override suspend fun getDepartments(language: String?): RepoResult<List<DepartmentDto>, *> {
        return when (val apiResult = departmentService.getDepartments(language = language)) {
